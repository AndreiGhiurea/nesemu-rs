...
pub enum InstructionVariant {
    ...
    TAY, TYA, DEY, INY, ROL, ROR, RTI, RTS, SBC, STA, TXS, TSX, PHA, PLA, PHP, PLP, STX, STY,
    // Unofficial opcodes
...
pub static INSTRUCTIONS: phf::Map<u8, Instruction> = phf_map! {
    ...
    0x04u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPage, length: 2, cycles: 3, emu_fn: Emu::nop},
    0x44u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPage, length: 2, cycles: 3, emu_fn: Emu::nop},
    0x64u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPage, length: 2, cycles: 3, emu_fn: Emu::nop},
    0x0Cu8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::Absolute, length: 3, cycles: 4, emu_fn: Emu::nop},
    0x14u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPageX, length: 2, cycles: 4, emu_fn: Emu::nop},
    0x34u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPageX, length: 2, cycles: 4, emu_fn: Emu::nop},
    0x54u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPageX, length: 2, cycles: 4, emu_fn: Emu::nop},
    0x74u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPageX, length: 2, cycles: 4, emu_fn: Emu::nop},
    0xD4u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPageX, length: 2, cycles: 4, emu_fn: Emu::nop},
    0xF4u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::ZeroPageX, length: 2, cycles: 4, emu_fn: Emu::nop},
    0x80u8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::Immediate, length: 2, cycles: 2, emu_fn: Emu::nop},
    0x1Cu8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::AbsoluteX, length: 3, cycles: 4, emu_fn: Emu::nop},
    0x3Cu8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::AbsoluteX, length: 3, cycles: 4, emu_fn: Emu::nop},
    0x5Cu8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::AbsoluteX, length: 3, cycles: 4, emu_fn: Emu::nop},
    0x7Cu8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::AbsoluteX, length: 3, cycles: 4, emu_fn: Emu::nop},
    0xDCu8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::AbsoluteX, length: 3, cycles: 4, emu_fn: Emu::nop},
    0xFCu8 => Instruction{variant: InstructionVariant::NOP, mode: AddressingMode::AbsoluteX, length: 3, cycles: 4, emu_fn: Emu::nop},
